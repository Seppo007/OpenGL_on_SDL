...
static glm::mat4 MVP;
static float rotationVar = 0;
static float xvar = 1.0f, yvar = 1.0f, zvar = 10.0f;
...
void updateMVP(glm::mat4 &MVP, GLuint &programID){
    ...
    // Model & MVP Matrix
    glm::mat4 rotate = glm::rotate(glm::mat4(1.0f), rotationVar, glm::vec3(0.0f, 1.0f, 0.0f));
    glm::mat4 Model = glm::mat4(1.0f) * rotate;
